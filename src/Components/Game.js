...
const spawnAsteroid = (elapsedTime, scene, camera, willHit = false) => {
    ...
    if(count!==countMax){
        ...
        const intersectionScalarOffsetMultiplier = (Math.random()<0.5?1:-1)*(Math.random()*(maxScalarOffsetMultiplier-minScalarOffsetMultiplier)+minScalarOffsetMultiplier)
        asteroidArray.push({
